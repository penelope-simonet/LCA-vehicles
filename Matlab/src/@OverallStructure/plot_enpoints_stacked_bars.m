function plot_enpoints_stacked_bars(obj)
% Use : OS.plot_enpoints_stacked_bars()
...
output_pdf = fullfile(output_dir, 'enpoints_stacked_bars.pdf');
...
output_xlsx = fullfile(source_dir, 'plot_enpoints_stacked_bars.xlsx');
