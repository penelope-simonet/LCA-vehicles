...
for i = 1:numel(obj.State)
    ...
    for cat = 1:n_cats
        ...
        operational_fleet = ...
            state.Midpoint_impacts(cat).value_direct_exhaust * vkm_per_year * n_cars_total;
        ...
        operational_new = ...
            state.Midpoint_impacts_new_cars(cat).value_direct_exhaust * vkm_per_year;
        ...
        operational_avg = ...
            state.Midpoint_impacts(cat).value_direct_exhaust * vkm_per_year;
