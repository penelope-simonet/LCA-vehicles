...
% Sheet 1 : share of planetary boundary (all EF categories)
...
writecell([header; data_out], output_xlsx, 'Sheet', 'share_planetary_boundary');

% Sheet 2 : planetary boundary values per Norway
...
writecell([pb_header; pb_data], output_xlsx, 'Sheet', 'planetary_boundary_values');
