function plot_figureS4_norm_2000_ReCiPe_endpoints(obj)

% Use : OS.plot_figureS4_norm_2000_ReCiPe_endpoints()
...
output_xlsx = fullfile(source_dir, 'figureS4_norm_2000_ReCiPe_endpoints.xlsx');
