function NormFactors = get_normalization_factors_EF()
...
% PB per capita = PB global / pop_ref
...
NormFactors.PB_per_capita = NormFactors.PB_global / pop_ref;

NormFactors.pop_ref = pop_ref;
